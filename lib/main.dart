...
import 'package:myapp/components/cardFreteGratis.dart';
import 'components/campoPesquisa.dart';
import 'components/cardAssinatura.dart';
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            const Padding(padding: EdgeInsets.all(5)),
            assinatura(titulo: "assina logo",),
            const Padding(padding: EdgeInsets.all(5)),
            freteGratis(),
            const Padding(padding: EdgeInsets.all(10)),
            assinatura(titulo: "assine o novo cartao noob")
          ],
        ),
